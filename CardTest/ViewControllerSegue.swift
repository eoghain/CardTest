...
class ViewControllerSegue: UIViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "embedCardNavigation" {
            guard let vc = segue.destination as? CardNavigationController else {
                fatalError("Uh oh!")
            }
            
            cardNavigationController = vc
...
extension ViewControllerSegue: CardNavigationDelegate {
...
extension ViewControllerSegue: CardNavigationDatasource {
...
extension ViewControllerSegue: ToggleProtocol {
    func toggle() {
